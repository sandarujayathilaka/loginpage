...
<div className="col-span-2 flex justify-center">
            ...
            <button
                className="bg-amber-700 rounded-[10px] mt-5 h-10 w-[200px] m-auto hover:bg-amber-900 text-white font-bold py-2 px-4 shadow focus:outline-none focus:shadow-outline"
                type="submit"
